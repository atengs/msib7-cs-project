        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Jenis Pembayaran</label>
                  <select
                    v-model="todo.jenis_pembayaran"
                    :class="errorField.jenis_pembayaran ? 'form-control input-lg input-error' : 'form-control input-lg'"
                    @change="periksaJenisPembayaran"
                  >
                    <option disabled value="">Pilih Jenis Pembayaran</option>
                    <option value="Retainer">Retainer</option>
                    <option value="One Shoot Project">One Shoot Project</option>
                  </select>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    refreshTable() {
    var mythis = this; // Gunakan referensi "this" untuk akses ke komponen
    mythis.status_table = false; // Set status loading tabel
    $("#wrapper2").remove(); // Hapus elemen tabel lama dari DOM
    var e = $('<div id="wrapper2"></div>'); // Buat elemen baru untuk tabel
    $("#box").append(e); // Tambahkan elemen baru ke container
    this.getTable(); // Panggil ulang fungsi untuk render tabel baru
  },
    saveTodo() {
      var mythis = this;
    ...
    server: {
      ...
      $(document).off("click", "#approveData");
      $(document).off("click", "#rejectData");
      $(document).off("click", "#showData");
