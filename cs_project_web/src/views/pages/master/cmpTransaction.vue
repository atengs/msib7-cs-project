                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-nf-email">Trans Number</label>
                        ...
                        @input="(val) => (todo.trans_number = todo.trans_number.toUpperCase())"
                  />
                </div>
              </div>
                  ...
                  <CmpInputText
                    ...
                    :class="
                      errorField.payment_status
                        ...
                        : 'form-control input-lg'
                    "
                    @input="(val) => (todo.payment_status = todo.payment_status.toUpperCase())"
                  />
                </div>
              </div>
              </div>
                  ...
                  <div class="form-group">
                    <label for="example-nf-email">Customer</label>
                        ...
                        errorField.customer
                            ...
                            : 'form-control input-lg'
                        "
                        @input="(val) => (todo.customer = todo.customer.toUpperCase())"
                  />
                </div>
              </div>
                  ...
                  <CmpInputText
                    ...
                    :class="
                      errorField.person_in_charge
                        ...
                        : 'form-control input-lg'
                    "
                    @input="(val) => (todo.person_in_charge = todo.person_in_charge.toUpperCase())"
                  />
                </div>
              </div>
              </div>
                  ...
                  <div class="form-group">
                    <label for="example-nf-email">Trans Date</label>
                        ...
                        errorField.trans_date
                            ...
                            : 'form-control input-lg'
                        "
                        @input="(val) => (todo.trans_date = todo.trans_date.toUpperCase())"
                  />
                </div>
              </div>
                  ...
                  <CmpInputText
                    ...
                    :class="
                      errorField.project
                        ...
                        : 'form-control input-lg'
                    "
                    @input="(val) => (todo.project = todo.project.toUpperCase())"
                  />
                </div>
              </div>
              </div>
                  ...
                  <CmpInputText
                    ...
                    :class="
                      errorField.finance_manager
                        ...
                        : 'form-control input-lg'
                    "
                    @input="(val) => (todo.finance_manager = todo.finance_manager.toUpperCase())"
                  />
                </div>
              </div>
              </div>
                  ...
                  <div class="form-group">
                    <label for="example-nf-email">Acount Executive</label>
                        ...
                        errorField.acount_executive
                            ...
                            : 'form-control input-lg'
                        "
                        @input="(val) => (todo.acount_executive = todo.acount_executive.toUpperCase())"
                  />
                </div>
              </div>
                  ...
                  <CmpInputText
                    ...
                    :class="
                      errorField.acount_manager
                        ...
                        : 'form-control input-lg'
                    "
                    @input="(val) => (todo.acount_manager = todo.acount_manager.toUpperCase())"
                  />
                </div>
              </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <CmpInputText
                    type="number"
                    placeholder="Nominal"
                    v-model="todo.ratecard_nominal"
                    :class="
                      errorField.ratecard_nominal
                        ? 'form-control input-lg input-error'
                        : 'form-control input-lg'
                    "
                    @input="(val) => (todo.ratecard_nominal = todo.ratecard_nominal.toUpperCase())"
                  />
                  <!-- <select
  ...
  export default {
    ...
    methods: {
      ...
      async getMasterJobList() {
        ...
        await axios
        .get(mythis.$root.apiHost + mythis.$root.prefixApi +`master-job-list`, config)
            .then(async (res) => {
      ...
      saveTodo() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            var url = mythis.$root.apiHost + mythis.$root.prefixApi +"trx-header";
            axios
              .post(
                url,
                {
                  ...
                  ratecard: [
                    {
                        ratecard_id: mythis.todo.ratecard,
                        ratecard_nominal : mythis.todo.ratecard_nominal,
                        note: "",
                    }
                ],
      ...
      editTodo() {
        ...
        axios
          .put(
            mythis.$root.apiHost + mythis.$root.prefixApi +"trx-header/" + mythis.todo.id,
            {
              trans_number: mythis.todo.trans_number,
              customer: mythis.todo.customer,
              trans_date: mythis.todo.trans_date,
      ...
      async getData(id) {
        ...
        await axios
        .get(mythis.$root.apiHost + mythis.$root.prefixApi +`trx-header/${id}`, config)
          .then(async (res) => {
            console.log(res.data.data);
            const data = res.data.data;
            //mythis.acuanEdit = id;
