...
export default {
  ...
  mounted() {
    ...
    localStorage.setItem("name", this.$root.encryptData("NAMA ANDA"));
    ...
    const myObject = {
      userAvatar:
        this.$root.appBaseUrl + "/public/26954e5e29b5c77937e5098d3e817bb5.png",
      userEmail: "abc@marthana.co.id",
      userName: "NAMA ANDA",
      userUuid: "abc@marthana.co.id",
    };
