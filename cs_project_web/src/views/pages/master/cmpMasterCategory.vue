  ...
  methods: {
    ...
    saveTodo() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          var url = mythis.$root.apiHostJWT + "api/mst-category";
          axios
            .post(
              url,
              {
    ...
    getTable() {
      ...
      this.grid.updateConfig({
        ...
        server: {
          url: this.$root.apiHostJWT + "api/mst-category/getData",
          then: (data) =>
    ...
    deleteTodo(id) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          axios
            .delete(
              mythis.$root.apiHostJWT + `api/mst-category/delete/${id}`,
              config
            )
            .then((res) => {
    ...
    editTodo() {
      ...
      axios
        .put(
          mythis.$root.apiHostJWT + "api/mst-category/update/" + mythis.todo.id,
          {
            category_name: mythis.todo.category_name,
            category_prefix: mythis.todo.category_prefix,
            userid: mythis.userid,
    ...
    async getData(id) {
      ...
      await axios
        .get(mythis.$root.apiHostJWT + `api/mst-category/getById/${id}`, config)
        .then(async (res) => {
          //console.log(res.data.data);
          //mythis.acuanEdit = id;
    ...
    async generateCode() {
      ...
      await axios
        .get(mythis.$root.apiHostJWT + `api/mst-category/generateCode`, config)
        .then(async (res) => {
          console.log(res)
          const data = res.data;
